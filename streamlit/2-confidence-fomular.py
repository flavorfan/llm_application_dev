...
st.write("""
# confidence sigmoid function fit
...
def user_input_features():
    a = st.sidebar.slider('a: x轴平移', 1, 20, 15,1)
    b = st.sidebar.slider('b：y轴平移', -1, 1, 0)
    c = st.sidebar.slider('c：x轴拉伸', -1.5, 1.0, -1.0, 0.1)
    d = st.sidebar.slider('d：y轴拉伸', 0.3, 1.5, 1.0, 0.05)
